...
Есть несколько методов добавления записи в базу данных. Здесь будет описан метод добавления записи вручную, то есть все
поля вы будете заполнять сами. Необходимо перейти к форме добавления записи выбрав пункт в главном меню: *Добавить
запись -> Заполнить вручную*
