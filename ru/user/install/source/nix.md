...
> ```
> Или Вы можете скачать сходники в виде архива и распаковать их:
> ```
...
Устанавите зависимости используя Composer:
...
Для того что бы запустить приложение Вам необходимо в терминале перейти в дирректорию в которую вы
устанавили приложение. В корне дирректории находится скрипт `AnimeDB` отвечающий за управление приложением.
